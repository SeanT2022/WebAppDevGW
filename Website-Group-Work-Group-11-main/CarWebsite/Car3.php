...
<body>
	...
	<div id="container">
		...
		<div class="hero">
			<div class="row">
				<div class ="text-sec">
					<h1 class="heading"> Jaguar <span> F-Pace </span> </h1>
				</div>
			</div>
		</div>
		...
		<div id="Details">
		<br>
			<img src="Images/Details3.png" alt="">	
		</div>
      ...
      <div class="row">
        <div class="col">
          <div class="review">
            ...
            <p>
              Very powerful car and reaches great speeds in no time. Amazing Colour to boot.
            </p>
          </div>
        </div>
		</div>
      ...
      <div class="row">
        <div class="col">
          <div class="review">
            ...
            <p>
              Love my car, this one however is alright.
            </p>
          </div>
        </div>
		</div>
      ...
      <div class="row">
        <div class="col">
          <div class="review">
            ...
            <p>
              Amazing for driving me to work.
            </p>
          </div>
        </div>
		</div>
...
<div class="col last">
			...
			<div class="center">
			<h2>Add a Review</h2>
			<form action="review_system3.php" method="post">
				<div class="txt">
					<label>Name:</label>
